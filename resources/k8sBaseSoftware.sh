...
# Add repo for Kubernetes ---- The URL for the repo (line 52) has to be updated everytime a new k8s version is going to be deployed (or upgraded to a more recent version)
